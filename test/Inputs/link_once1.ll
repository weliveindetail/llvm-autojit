; ModuleID = '/workspace/llvm-autojit/test/Inputs/link_once1.ll'
source_filename = "/workspace/llvm-autojit/test/Inputs/link_once1.ll"
...
define ptr @call_link_once1(ptr %s) {
entry:
