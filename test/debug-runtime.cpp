...
// FIXME: We could dump all debug output if we enabled it in a static
// initializer like the one below. It's commented out right now, because it
// fails assertion "Resolving symbol with incorrect flags" in:
